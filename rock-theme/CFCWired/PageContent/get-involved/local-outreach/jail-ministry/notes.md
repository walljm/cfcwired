# Jail Ministry Import Notes

Source page: `src/get-involved/local-outreach/jail-ministry.html`

## Rock Page

- Page name: Jail Ministry
- Suggested route: `/get-involved/local-outreach/jail-ministry`
- Layout: `Homepage.aspx`
- Browser title: `Jail Ministry - Christian Fellowship Church`
- Meta description: `CFC Jail Ministry serves incarcerated individuals and their families in Loudoun County.`
...
1. Create or open the Rock page at `/get-involved/local-outreach/jail-ministry`.
