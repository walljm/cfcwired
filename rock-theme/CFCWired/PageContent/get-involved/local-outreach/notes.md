# Local Outreach Import Notes

Source page: `src/get-involved/local-outreach.html`

## Rock Page

- Page name: Local Outreach
- Suggested route: `/get-involved/local-outreach`
- Layout: `Homepage.aspx`
- Browser title: `Local Outreach - Christian Fellowship Church`
- Meta description: `Local outreach opportunities at Christian Fellowship Church.`
...
1. Create or open the Rock page at `/get-involved/local-outreach`.
